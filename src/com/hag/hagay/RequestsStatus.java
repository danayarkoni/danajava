...
public final class 		RequestsStatus {
	public 	static final 	String 		requestsStatusForm(String cfgMenuWebUser,String cfgMenuWebPass,String keyString,String sum){
    	...
    	/*
		ans3.add("<h2><u>Requests log111111111111111:</u></h2>");
		...
		String rc= selectRequestStatus("SQL","CONFG1","cfg","cfg09c",HagParam.getConfg1DB(),stm3,ans,true,null,cfgMenuWebUser,cfgMenuWebPass,null,sum);
		if(rc.startsWith("0~")){
...
public 	static final 	String 		requestsStatusForm500(String cfgMenuWebUser,String cfgMenuWebPass,String keyString,String sum){
		...
		String rc= selectRequestStatus500("SQL","CONFG1","cfg","cfg09c",HagParam.getConfg1DB(),stm3,ans,true,null,cfgMenuWebUser,cfgMenuWebPass,null,"All");
		if(rc.startsWith("0~")){
			String str = ans.convertToString(" ");
	...
	public 	static			String 		cancelRequest(HagStringList cbEnvs1,String sentBy){
	...
	public 	static 			String 		reopenRequest(HagStringList cbEnvs1,String sentBy){
	...
	public 	static 			String 		requestDetails(HagStringList cbEnvs1,String sentBy){
	...
	for(int i = 0 ; i <cbEnvs1.size();i++) {
		...
		String requestStatus= HagUtil.getWord0(temp, "~", 3, true) ;
		String lastUpdatedBy= HagUtil.getWord0(temp, "~", 4, true) ;
		String requestSubject= HagUtil.getWord0(temp, "~", 6, true) ;
		String lastUpdatedAt= HagUtil.getWord0(temp, "~", 7, true) ;
		String request8= HagUtil.getWord0(temp, "~", 8, true) ;
		String request9= HagUtil.getWord0(temp, "~", 9, true) ;
		String requestNote= HagUtil.getWord0(temp, "~", 10, true) ;
		String requestDate= HagUtil.getWord0(temp, "~", 1, true) ;
		String request11= HagUtil.getWord0(temp, "~", 11, true) ;
		String requestType= HagUtil.getWord0(temp, "~", 12, true) ;
		String request13= HagUtil.getWord0(temp, "~", 13, true) ;
		String requestInstallOn= HagUtil.getWord0(temp, "~", 14, true) ;
		String request15= HagUtil.getWord0(temp, "~", 15, true) ;
		String request16= HagUtil.getWord0(temp, "~", 16, true) ;
		String request17= HagUtil.getWord0(temp, "~", 17, true) ;
		String request18= HagUtil.getWord0(temp, "~", 18, true) ;
		String request19= HagUtil.getWord0(temp, "~", 19, true) ;
		String request20= HagUtil.getWord0(temp, "~", 20, true) ;
		...
		ans.add("<table bgColor=\"dddddd\" id=\"table2\" cellpadding=\"1\" cellspacing=\"1\" border=\"1\" >");
		ans.add("<tr bgColor=\"aaaaaa\"><td>var</td><td>val</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>req</td><td>"+req+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>request date</td><td>"+requestDate+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>requester</td><td>"+requester+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>request status</td><td>"+requestStatus+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>request subject</td><td>"+requestSubject+"</td></tr>");
		
		ans.add("<tr bgColor=\"dddddd\"><td>last updated by</td><td>"+lastUpdatedBy+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>last updated at</td><td>"+lastUpdatedAt+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request8</td><td>"+request8+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request9</td><td>"+request9+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>request note</td><td>"+requestNote+"</td></tr>");
		
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request11</td><td>"+request11+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>request type</td><td>"+requestType+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request13</td><td>"+request13+"</td></tr>");
		ans.add("<tr bgColor=\"dddddd\"><td>install on</td><td>"+requestInstallOn+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request15</td><td>"+request15+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request16</td><td>"+request16+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request17</td><td>"+request17+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request18</td><td>"+request18+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request19</td><td>"+request19+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>request20</td><td>"+request20+"</td></tr>");
		//ans.add("<tr bgColor=\"aaaaaa\"><td>temp</td><td>"+temp+"</td></tr>");
		ans.add("</table>");
		*/
	}
	...
	public 	static 			String 		requestHistory(HagStringList cbEnvs1,String sentBy){
	...
	for(int i = 0 ; i <cbEnvs1.size();i++) {
		...
		HagStringList list = getRequestHistory(req);
		if(list.size()==0) {
	...
	public 	static final 	String 			selectRequestStatus(String dbms,String server,String user,String pass,String db,String stm,HagStringList ans,
	         ...
	         boolean first =true;
	  		...
	  		while (rs.next()) {
		               	...
		               	if(i==0)
		            		...
		            		temp0.append("<select name=\"col"+i+"\"  onchange=\"this.form.submit()\">");
		             		...
		             		temp0.append("<select name=\"col"+i+"\"  onchange=\"this.form.submit()\">");
		           			//temp0.append("<select name=\"col4\"  onchange=\"this.form.submit()\">");
		           			HagStringList cc = new HagStringList();
		           			String stm1 = "select distinct "+colName+" from dbo.req_ind_log_new order by "+colName;
		           			String rc1= selectIntoList("SQL","CONFG1","cfg","cfg09c",HagParam.getConfg1DB(),stm1,cc,"`");
		           			//updateListRemoveDate(cc,true);
		           			temp0.append("<option value=\"[ALL]\">[ALL]</option>");
		           			for(int h = 0 ; h < cc.size();h++){
        	 	...
        	 	ans.add("<input type=\"hidden\" name=\"cfgMenuWebPass\" id=\"cfgMenuWebPass\" value = \""+cfgMenuWebPass+"\" >");
           	    	...
           	    	HagStringList list1 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\requestsStatusOptions.txt",true,"*",false);
           	        ...
           	        HagStringList list2 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\riEnvsReqOptions.txt",true,"*",false);
         	    	...
         	    	HagStringList list3 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\riEnvsManagerOptions.txt",true,"*",false);
	...
	public 	static final 	String 			selectRequestStatus500(String dbms,String server,String user,String pass,String db,String stm,HagStringList ans,
			boolean withTitles,String[] filter,String cfgMenuWebUser,String cfgMenuWebPass,String keyString,String sum){
		Connection con = getSqlConn( server, user, pass, db,"dbo");
		if(con==null)
			return "1~failed to create connection";
	...
	public 	static 			String 			getWhereLine(String keyString) {
		String whereLine=" where LOWER(ind) like LOWER('%"+keyString+"%') or "+ 
	...
	public 	static final 	String 			replaceColName(String name){
		if(name.equals("dateTime")){
			return "first sent at";
		}else if(name.equals("doneBy")){
			return "first sent by";
		}else if(name.equals("owner")){
			return "status changed by";
		}else if(name.equals("ind")){
			return "request number";
		}else if(name.equals("dateTimeLastUpd")){
			return "last updated";
		}else if(name.equals("tgtEnv")){
			return "target environment";
		}else if(name.equals("When_To_Install")){
			return "Start request after";
		}
		return name;
	}
	...
	public 	static final 	HagStringList 	getRequestHistory(String req){
		String stm3 = "select subAct,hotfix,rc,dateTime,byWho from dbo.RI_PRC where hotfix='#"+req+"' order by dateTime DESC";
		HagSQL hagSQL1=new HagSQL();
