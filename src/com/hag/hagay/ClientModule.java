...
public static 		String 			insertClientModuleMig(HttpServletRequest request, HttpServletResponse response,String plat,String user){
		return insertClientModuleMig_before(plat,user);
	}
public static final String 			insertClientModuleMig_before(String plat,String user){
		...
		sb.append("<font size=6 color=\"GREEN\"><u>Add ClientModule futureRelease-mig request form:").append("</u></font><br><br>")
		.append("<font size=2 color=\"blue\">Select the correct option and submit the form</font><br><br>")
		.append("<FORM METHOD=POST name=\"Form\" ACTION=\"clientModuleFutureReleaseAddMigRequest.jsp\" >")
		.append("<table bgcolor=\"#aaaacc\" border=\"1\" style=\"width:70%\">")
		.append("<tr><td bgcolor=\"#ccccaa\">ClientModule futureRelease version</td><td>").append(clientModuleVer).append("</td></tr>")
...
public static final String 			getClientModuleVerLines(){
		HagStringList list = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\clientModuleFutureReleaseVersions.txt",false,"xxssss",false);
...
public static final String 			clientModuleMigsListForm(String cfgMenuWebUser,String cfgMenuWebPass){
    	...
    	String stm = "select jira," +
    				...
    				"note " +
    				" from dbo.add_mig_clientModuleFutureRelease order by dt_dev desc";
		String rc= selectClientModuleFutureReleaseMigsList("SQL","CONFG1","cfg","cfg09c",HagParam.getConfg1DB(),stm,ans,true,null,cfgMenuWebUser,cfgMenuWebPass);
		if(rc.startsWith("0~")){
			String str = ans.convertToString(" ");
			String ffT = HagUtil.cfgMenuWebLoc+"\\tableSortT14.html";
...
public static final String 			selectClientModuleFutureReleaseMigsList(String dbms,String server,String user,String pass,String db,String stm,HagStringList ans,boolean withTitles,String[] filter,String cfgMenuWebUser,String cfgMenuWebPass){
	    	...
	    	try {
		         ...
		         boolean first =true;
		  		...
		  		while (rs.next()) {
		        	 ...
		        	 count1++;
		         	if(first){
		         		ans.add("<FORM METHOD=POST STYLE=\"margin: 0px; padding: 0px;\" name=\"Form11\" id=\"Form11\"  ACTION=\"filterClientModuleFutureReleaseAddMigs.jsp\">");
		         		//combo
			              	...
			              	String colName = metaData.getColumnName(i + 1);
			               	if(i==0)
			            		...
			            		temp0.append("");
			           			...
			           			String stm1 = "select distinct "+colName+" from dbo.add_mig_clientModuleFutureRelease";
	        	 	...
	        	 	devCombo.append("<select style=\"background-color: yellow\" id=\"act1\" name =\"act1\" onchange=\"this.form.submit();this.selectedIndex = 0\">");
	           	    	...
	           	    	HagStringList list1 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\clientModuleFutureReleaseMigDevOptions.txt",true,"*",false);
	        	 	...
	        	 	devCombo.append("</select>");
	           	       ...
	           	       requestCombo.append("<select style=\"background-color: yellow\" id=\"act2\" name =\"act2\" onchange=\"this.form.submit();this.selectedIndex = 0\">");
	           	        HagStringList list2 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\clientModuleFutureReleaseMigCmOptions.txt",true,"*",false);
	           	   ...
	           	   //requestCombo.append("Future");
	         	    	...
	         	    	HagStringList list3 = new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\clientModuleFutureReleaseMigManagerOptions.txt",true,"*",false);
...
public 				String 			clientModuleFutureReleaseAddMigRequest(HttpServletRequest request, HttpServletResponse response){
		...
		return requestsClientModuleFutureReleaseAddMigRequestSent(sentBy,jClass,jiraTask,note,runTypeHotfix,cbgroup1,null);
...
public static final String 			requestsClientModuleFutureReleaseAddMigRequestSent(String sentBy,String jClass,String jiraTask,String note,String runTypeHotfix,String[] jiraVers,String dupId){
	...
	jClass=jClass.trim();
	String stm1 = "select id from dbo.add_mig_clientModuleFutureRelease where jclass='"+jClass+"' and run_type<>'40'";
	...
	for(int i=0;i< jiraVers.length;i++){
		...
		checkIfMigLineExists(hagRcs[i],sentBy,jClass,cmVer,"add_mig_clientModuleFutureRelease");
		if(hagRcs[i].rc !=0){
			continue;
		}
		...
		HagUtil.insertIntoMigHf(hagRcInsertToMigTable,jClass, jiraTask, cmVer, "{ALL}", runTypeW0a,".","this_ver_only", sentBy,ind, note,true,"add_mig_clientModuleFutureRelease");
		if(hagRcs[i].rc!=0)
	...
	ans.append("<tr bgcolor=\"#ccccaa\"><td>ClientModule furureRelease version</td><td>RC</td><td>log</td></tr>");
...
public 				String 			filterClientModuleFutureReleaseAddMigs(HttpServletRequest request, HttpServletResponse response){
	...
	String stm = "select jira," +
			...
			"note " +
			" from dbo.add_mig_clientModuleFutureRelease order by dt_dev desc";
	String rc= selectClientModuleFutureReleaseMigsList("SQL","CONFG1","cfg","cfg09c",HagParam.getConfg1DB(),stm,ans,true,filter,cfgMenuWebUser,cfgMenuWebPass);
	if(rc.startsWith("0~")){
		String str = ans.convertToString(" ");
		String ffT = HagUtil.cfgMenuWebLoc+"\\tableSortT14.html";
		HagStringList listT = new HagStringList(ffT,false,"xxssss",false);
...
*/
public static String 	requestClientModuleFutureReleasePack(HagStringList cbEnvs1,String sentBy){
	
	String ansCheck = HagUtil.checkTOPACK("\\\\HYUNDAI.SAPIENS.COM\\HYUN05ri\\DEV\\V0801m00\\TOPACK\\ClientModule\\CMv2.0\\",HagUtil.cfgMenuWebLoc+"\\lists\\clientmoduleFutureReleaseFiles.txt");
	if (ansCheck != null)
		return ansCheck;
	...
	//String bkupF = HagUtil.cfgMenuWebLoc+"\\getBackups.html";
		ans.append("<h3>Pack ClientModuleFutureRelease request</h3>");

		ans.append("<FORM METHOD=POST name=\"Form\" ACTION=\"sendPackClientModuleFutureReleaseRequest.jsp\">");
		...
		//ver
		String clientModuleFutureReleaseVer = "";
		String riVer = "";
		ans.append("<td><select  class=\"c30\" id=\"ver\" name =\"ver\" >");
		HagStringList ver1= new HagStringList(HagUtil.cfgMenuWebLoc+"\\lists\\clientModuleFutureReleaseVersions.txt",true,"*",false);
		for(int i=0;i<ver1.size();i++) {
			String clientModuleFutureReleaseVerLine = ver1.get(i);
			clientModuleFutureReleaseVer = HagUtil.getWord0(clientModuleFutureReleaseVerLine,"|", 0,true);
			riVer = HagUtil.getWord0(clientModuleFutureReleaseVerLine,"|", 1,true);
			ans.append("<option  value=\"").append(clientModuleFutureReleaseVer).append("\">").append(clientModuleFutureReleaseVer).append("</option>");
		}
		...
		int[] error = {0,0};
		String location = "\\\\HYUNDAI.SAPIENS.COM\\HYUN05ri\\DEV\\V"+riVer+"\\TOPACK\\ClientModule\\CM"+clientModuleFutureReleaseVer.substring(clientModuleFutureReleaseVer.indexOf("_")+1,clientModuleFutureReleaseVer.length());
...
public static 		String 			requestClientModuleFutureReleasePack(HagStringList cbEnvs1,String sentBy){
	...
	String bkupF = HagUtil.cfgMenuWebLoc+"\\getBackups.html";
		ans.append("<h3>Pack ClientModule FutureRelease request</h3>");
...
public 				String 			setInstOn(String[] installOnId, String[] installOnDb,String ff,String folder){
	...
	list.writeToFile(HagUtil.cfgMenuLoc+"\\bin\\"+folder+"\\"+ff, false);
	return ans.toString();
}
public 				String 			sendClientModuleFutureReleaseRequest_prepPackage(HagRc hagRc,String ver,StringBuilder migD,HagStringList toDoList){
	String folderS = "\\\\HYUNDAI.SAPIENS.COM\\HYUN05ri\\cfg\\clientModuleFutureRelease\\ARIA\\"+ver;
	String folderS1 = "\\\\HYUNDAI.SAPIENS.COM\\HYUN05ri\\cfg\\clientModuleFutureRelease\\ARIA\\backup\\";
	...
	//create folders
	clientModuleFutureReleaseRequest_buildFolders(hagRc,folderS);
	if(hagRc.rc!=0)	return folderS;
	

	//skel\\config.txt
	clientModuleFutureReleaseRequest_configTxt(hagRc,folderS,ver);
	if(hagRc.rc!=0)	return folderS;
	
	
	//config\\todo.txt
	clientModuleFutureReleaseRequest_todo(hagRc,folderS,toDoList,migD);
	if(hagRc.rc!=0)	return folderS;
...
public 				void 			clientModuleFutureReleaseRequest_buildFolders(HagRc hagRc,String folderS){
	//folders
...
public 				void 			clientModuleFutureReleaseRequest_configTxt(HagRc hagRc,String folderS,String ver){
...
public void 		clientModuleFutureReleaseRequest_todo(HagRc hagRc,String folderS,HagStringList list,StringBuilder migD){
...
public 				void 			clientModuleFutureReleaseRequest_todo11111111111111(HagRc hagRc,String folderS,HagStringList list,StringBuilder migD){
	String toDo1 = "\\\\ri-archive\\Saptech-Archive\\RI\\HAT_pack\\skel_clientModule\\bin\\config\\tree\\riInstallClientModule\\todo1.txt";
	String toDo2 = "\\\\ri-archive\\Saptech-Archive\\RI\\HAT_pack\\skel_clientModule\\bin\\config\\tree\\riInstallClientModule\\todo2.txt";
	HagStringList toDoList1 = new HagStringList(toDo1,false,"asasa",false);
	HagStringList toDoList2 = new HagStringList(toDo2,false,"asasa",false);
	...
	for(int i = 0;i<list.size();i++){
		...
		if(w0.equals("manualMigs")){
			...
			String  cust = HagUtil.getWord0(w1,"#",4,true);
			String ww= id+"#"+jClass+"#"+runType;
			toDoListOrder2.add("Manual Mig "+ww+"          | sfManualMig#"+ww+"    | Y | N | Y | 50 |     Manual Mig     | riJava_folder,Batch_name,#cmPackage,!"+ww+",SQL_server,Database_name,Bulk_user,Bulk_pass,!"+run+",!"+cust+"                                            | 1 | N");                                                                                                                                                                                                                       
...
public 				String 			sendPackClientModuleFutureReleaseRequest(HttpServletRequest request, HttpServletResponse response){
...
//	}
	...
	//contentM.add("Request to create ClientModule FutureRelease package<br>");
	...
	//
	String dateTime = HagUtil.getDateTime("yyyy/MM/dd-HH:mm");
	StringBuilder stm3= new StringBuilder("Update "+HagParam.getConfg1DB()+".[dbo].add_mig_clientModuleFutureRelease ")
		.append("set manager='"+sentBy+"',dt_manager='"+dateTime+"',pack2ver='"+ver+"' where ");
	//.append("set manager='"+sentBy+"',dt_manager='"+dateTime+"' where ");
	//
	String stm3S ="";	
	...
	String folder = "";
	folder = sendClientModuleFutureReleaseRequest_prepPackage( hagRc,ver,   migD,toDoList);
	...
	if(!testOnly) {
		if(hf1!=null && hf1.length>0){
			HagSQL hagSQL = new HagSQL();
			int changed = hagSQL.updateStm("confg1", "cfg","cfg09c", HagParam.getConfg1DB(),  stm3S);
			ans.add(changed+" rows in ClientModuleFutureRelease table change to "+ver+" by "+sentBy+"<br>");
		}
	}
	if(testOnly) {
		toList="david.ha@sapiens.com";
	...
	//hagayhagay
	String subject 	= pre+"Request to create ClientModule "+ver+" FutureRelease package @BREAK-REQ@ #"+indS+"# sent by "+sentBy;
	if(!HagUtil.addRequest(ind,sentBy, ".",subject,"./.",".",".",instOn2,null,null,null,999))
		return HagUtil.shortHtml("Error adding request-mail sent to hagay & gonen, please call hagay or gonen", "red","bg");
	String ansS = ans.convertToString("");
